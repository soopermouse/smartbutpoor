...
public function insert(){
	require 'connectsmart1.php';
$query="SELECT * FROM employers WHERE `emp_name`='$this->ename' && `emp_email`='$this->eemail' && `emp_password`='$this->epassword'; ";
...
$lol->password(md5($_POST['password']));
$message=$lol->insert();
}
?>
<html>
...
<a href="employersignup.php"><h3>EMPLOYER SIGNUP</h3></a>
</div>
