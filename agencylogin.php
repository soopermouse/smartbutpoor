...
print_r(mysqli_connect_error()).'</br>';
...
public function insert(){
	require 'connectsmart1.php';
$query="SELECT * FROM agencies WHERE `agency_name`='$this->aname' && `agency_email`='$this->aemail' && `agency_password`='$this->apassword';";
...
<a href="agencysignup.php"><h3>AGENCY SIGNUP</h3></a>
</div>
